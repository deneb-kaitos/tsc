...
pub fn addTests(
    ...
    lib_run_tests.setEnvironmentVariable("REDIS_USERNAME", "prj:tests:username");
    lib_run_tests.setEnvironmentVariable("REDIS_PASSWORD", "1d804989d5b1d10e98bc06ffa8d5537f0591344adebe3439baf5028a3b20f951");
